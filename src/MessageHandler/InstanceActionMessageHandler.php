...
class InstanceActionMessageHandler implements MessageHandlerInterface, LoggerAwareInterface
{
    ...
    public function __invoke(InstanceActionMessage $message)
    {
        ...
        $this->logger->debug("[InstanceActionMessageHandler:__invoke]::Dispatching InstanceStateMessage ".json_encode($message_array, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE)." []");
