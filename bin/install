...
phpenmod -v 8.4 dom
update-alternatives --set php /usr/bin/php8.4 # PPRI0603 : Ajout des 4 lignes suivantes pour forcer l'utilisation de php8.1
...
echo "[ \e[32mOK\e[39m ] Increase route cache for ipv6"
...
echo "[ \e[32mOK\e[39m ] Increase lxc capabilities"
